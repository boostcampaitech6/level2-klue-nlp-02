...
class NewTrainer(Trainer):
    def __init__(self, loss_fn, gamma=2, alpha=0.25, *args, **kwargs):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if self.loss_fn == "CE":
            ...
            loss_function = loss_fn("FocalLoss", self.gamma, self.alpha)
...
def loss_fn(loss_fn: str = "FocalLoss", gamma: float = 2, alpha: float = 0.25):
    """
