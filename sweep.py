...
def train(configs):
    ...
    trainer = NewTrainer(
        ...
        gamma=gamma, # gamma to new trainer 
    ...
    # train model
    trainer.train()
    model.save_pretrained("/data/ephemeral/00_git_file/best_model/xlm_dist1_48_3_5e5_Focal_test1")
...
if __name__ == "__main__":
    with open("/data/ephemeral/00_git_file/config/sweep.yaml") as f:
